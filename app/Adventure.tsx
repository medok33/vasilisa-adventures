...
const emptyProgress: Progress = {
  ...
  balance: 0, goalTitle: "", goalAmount: 0, phone: "", reserveStar: false,
};
...
export default function Adventure() {
  ...
  if (view === "wallet") return <WalletScreen progress={progress} todayLimit={todayLimit} tomorrowLimit={tomorrowLimit} onBack={() => setView("home")} />;
